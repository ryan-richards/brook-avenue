          ...
          <div class="block pt-5">
            ...
            <div class="center">
              <div class="has-text-left" style="max-width: 60vh">
                <p>
                  Brook Avenue is a family run business with years of experience
                  making arguably the best gelato in Northern Ireland.
                </p>
                <p class="pt-2">
                  Using all natural ingredients we make unique twists on the
